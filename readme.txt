...
최적화는 아담 로스펑션은 교차엔트로피이며 마지막을 제외한 모든 활성화함수는 relu입니다. keras의 기본 평가 함수를 통해 정확도를 알려줍니다.
...
수 없다고 생각해서 제가 바닥부터 완벽히 이해하고 있는 기본CNN을 이용했습니다. 구글의 API들은 시간을 들여서 계속 공부해 나갈 것입니다. 남에 것이 아닌 오직
제 능력으로 구현해보는 것이 목표였습니다. 앞으로 더 열심히 배울 준비가 되어있습니다.
